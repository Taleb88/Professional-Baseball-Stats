...
for x in range(2016,2025):
    ...
    oakland_athletics_offensive_stats_df = oakland_athletics_stats_df[0]
    oakland_athletics_offensive_stats_df.to_csv(f'mlb/{x}_oakland_athletics_offensive_stats.csv', index=False)
    time.sleep(20) # timing server requests accordingly to prevent 429 error # timing server requests accordingly to prevent 429 error
