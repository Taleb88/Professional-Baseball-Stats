    ...
    try: 
        ...
        for year in range(1937,1949):
            try: 
                ...
                print(f'cannot filter rows for 1937-49 offensive stats accordingly - {type(e)}')        
    except Exception as e:
        print(f'cannot filter rows for 1924-1931 offensive stats accordingly - {type(e)}')